...
以下のJSON形式のみで回答してください。余分なテキストは不要です：
{
  ...
  "recommended_action": "【絶対禁止】着信拒否・電話を切る・無視するなど、電話を受けないことを勧める表現は一切使わない。発信元が明確な詐欺・フィッシングであっても「着信拒否」とは書かず「応答しないことをお勧めします」「個人情報は絶対に伝えないでください」などの表現にとどめる。この電話を受けた人への有益な案内を1〜2行で書く。",
